...
protected:
    ...
    ovrSysErrorCode   SysCode = 0;             /// May be ovrSysErrorCodeSuccess to indicate there isn't a relevant system error code.
...
OVRError MakeError(ovrResult errorCode, ovrSysErrorCode sysCode, const char* pSourceFile,
    ...
    const char* pDescriptionFormat, ...) OVR_LOG_VAARG_ATTRIBUTE(8, 9);
